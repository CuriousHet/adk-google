...
def before_model_callback(
    ...
    if last_user_message and "fat" in last_user_message.lower():
        print("=== INAPPROPRIATE CONTENT BLOCKED ===")
        print("Blocked text containing prohibited word: 'fat'")
            ...
            content=types.Content(
                ...
                parts=[
                    types.Part(
                        ...
                        "Please rephrase your request without using words like 'fat'."
                    )
                ],
            )
        )
